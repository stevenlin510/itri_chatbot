...
from .audio2face_pb2 import PushAudioRequest, PushAudioRequestStart, PushAudioStreamRequest
    ...
    with grpc.insecure_channel(url) as channel:
        ...
        def make_generator():
            ...
            for i in range(len(audio_data) // chunk_size + 1):
                ...
                yield PushAudioStreamRequest(audio_data=chunk.astype(np.float32).tobytes())
